...
export default function Upcoming() {
  ...
  React.useEffect(() => {
    axios
    .get(`https://api.themoviedb.org/3/movie/upcoming?api_key=2f0913db0269ec28b96e2c24a013e448&language=en-US&page=1`)
    .then(response => {
    ...
    return (
      <div>
        <header>
          ...
          <Button className={classes.nav} component={Link} to={'/top'}>Top Movies</Button>
